...
$zipPath = Join-Path $distDir "LookupFilteredSubgridSolution_1_6_0_0.zip"
...
<ImportExportXml version="9.2.25034.180" SolutionPackageVersion="9.2" languagecode="1033" generatedBy="CrmLive" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <SolutionManifest>
    ...
    <LocalizedNames>
      <LocalizedName description="Lookup Filtered Subgrid 1.6.0" languagecode="1033" />
    </LocalizedNames>
    <Descriptions>
      <Description description="PCF subgrid filtered by a form lookup value, with CRUD support for Power Pages. 1.6.0" languagecode="1033" />
    </Descriptions>
